        ...
        <section class="container py-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 d-flex">
                    <a href="https://khoacntt.ntu.edu.vn/tin-tuc/k-niem-20-nam-thanh-lap-khoa-cong-nghe-thong-tin" class="text-decoration-none text-dark w-100">
                        <div class="shadow rounded overflow-hidden news-card h-100">
                            <img src="./Image/news20nam.jpg" class="w-100 news-img">
                ...
                <!-- Bài 2 -->
                <div class="col-md-4 d-flex">
                    <a href="https://ntu.edu.vn/tin-tuc/phong-trao-nghien-cuu-khoa-hoc-sinh-vien-khoa-cong-nghe-thong-tin-%E2%80%93-truong-dai-hoc-nha-trang--buoc-chuyen-minh-va-trien-vong-tuong-lai" class="text-decoration-none text-dark w-100">
                        <div class="shadow rounded overflow-hidden news-card h-100">
                            <img src="./Image/news_nckh.jpg" class="w-100 news-img">
                            <div class="p-3 news-content">
                                <h6 class="fw-bold">Phong trào nghiên cứu khoa học sinh viên Khoa CNTT</h6>
                ...
                <!-- Bài 3 -->
                <div class="col-md-4 d-flex">
                    <a href="https://ntu.edu.vn/tin-tuc/sinh-vien-truong-dh-nha-trang-dat-thanh-tich-cao-tai-ky-thi-olympic-toan-hoc-sinh-vien-va-hoc-sinh-toan-quoc-lan-thu-30" class="text-decoration-none text-dark w-100">
                        <div class="shadow rounded overflow-hidden news-card h-100">
                            <img src="./Image/news_olympic.jpg" class="w-100 news-img">
                            <div class="p-3 news-content">
